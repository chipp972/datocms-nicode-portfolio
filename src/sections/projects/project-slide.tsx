...
export const ProjectSlide: React.FC<Project & Props> = ({ name, excerptNode, mainImage, technos, readMoreLabel, isCurrentSlide }) => {
  ...
  return (
    <SwiperSlide
      ...
      <button
        ...
        className={clsx(buttonCss.mediumButton, css.readMoreButton)}>{readMoreLabel}</button>
    </SwiperSlide>
  );
};
